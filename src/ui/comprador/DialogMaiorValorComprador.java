...
public class DialogMaiorValorComprador extends JDialog{
    private CatalogoParticipantes catalogoParticipantes;
    public DialogMaiorValorComprador(CatalogoParticipantes catalogoParticipantes){
        super();
        ...
        areaTexto.setText(maiorComprador());
    ...
    public String maiorComprador(){
        return catalogoParticipantes.consultarCompradorComMaisVendas();
    }
}
