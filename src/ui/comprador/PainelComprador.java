...
public class PainelComprador extends JPanel implements ActionListener{
    ...
    public PainelComprador(HomePage home, CatalogoParticipantes catalogoParticipantes){
        ...
        vermelho = new Color(233, 37, 37);
        layout = new BoxLayout(this, BoxLayout.Y_AXIS);
        //===============================================
            fontBotoes = new Font("SansSerif", Font.BOLD, 25);
            bordaBotao = new MatteBorder(2,2, 2, 2, vermelho);
        ...
        //=============================================== 
            ...
            bordaTF = new MatteBorder(0, 0, 4, 0, vermelho);
            tituloTF = new JLabel("Métodos de Comprador");
