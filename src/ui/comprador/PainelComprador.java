    ...
    public PainelComprador(){
        ...
        //===============================================
            ...
            //===============================================
                ...
                JLabel tituloTF = new JLabel("Metodos de Comprador");
            ...
            //===============================================
                ...
                //===============================================
                    ...
                    JButton botao22= new JButton("Mostrar Comprador");
                    MatteBorder bordaBotoes22 = new MatteBorder(2, 2, 2, 2, Color.RED);
                    botao22.setPreferredSize(new Dimension(250, 100));
                    botao22.setOpaque(true);
                    botao22.setBorder(bordaBotoes22);
                    botao22.setBackground(Color.RED);
